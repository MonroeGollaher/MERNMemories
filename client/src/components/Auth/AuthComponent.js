      ...
      <Paper className={ classes.paper } elevation={ 3 }>
        ...
        <form className={ classes.form } onSubmit={ handleSubmit }>
          <Grid container spacing={ 2 }>
            ...
            { isSignedUp && <AuthInput name="confirmPassword" label="Repeat Password" handleChange={ handleChange } type="password"/>}
          </Grid>
          <Button type="submit" fullWidth variant="contained" color="primary" className={ classes.submit }>
            { isSignedUp ? 'Sign Up' : 'Sign In'}
          </Button>
          <GoogleLogin 
            clientId="214995439726-gat0aiolnb3qkgsqs6nc0oke430i6nu6.apps.googleusercontent.com"
            render={ (renderProps) => (
              <Button 
